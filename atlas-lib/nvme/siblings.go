...
// against current kernel state instead — re-scanning, because a namespace may
// have been attached since — is the job of whatever holds the resolvers, since
// that is also what knows what a rescan costs.
