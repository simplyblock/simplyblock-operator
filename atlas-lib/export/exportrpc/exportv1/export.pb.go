...
const file_export_proto_rawDesc = "" +
	...
	"\x04spec\x18\x01 \x01(\v2\x1b.atlas.export.v1.ExportSpecR\x04spec\"\x16\n" +
	"\x14DeleteExportResponse2\xc9\x01\n" +
	"\rExportService\x12[\n" +
	"\fCreateExport\x12$.atlas.export.v1.CreateExportRequest\x1a%.atlas.export.v1.CreateExportResponse\x12[\n" +
	"\fDeleteExport\x12$.atlas.export.v1.DeleteExportRequest\x1a%.atlas.export.v1.DeleteExportResponseBAZ?github.com/simplyblock/atlas/export/exportrpc/exportv1;exportv1b\x06proto3"
...
var file_export_proto_depIdxs = []int32{
	...
	1, // 2: atlas.export.v1.ExportService.CreateExport:input_type -> atlas.export.v1.CreateExportRequest
	3, // 3: atlas.export.v1.ExportService.DeleteExport:input_type -> atlas.export.v1.DeleteExportRequest
	2, // 4: atlas.export.v1.ExportService.CreateExport:output_type -> atlas.export.v1.CreateExportResponse
	4, // 5: atlas.export.v1.ExportService.DeleteExport:output_type -> atlas.export.v1.DeleteExportResponse
