...
| `snapshotcontroller.create`             | create snapshot controller and CRD for snapshot support it                                                                                                    | `true`                                                                  |  |
| `externallyManagedConfigmap.create`    | Specifies whether an `externallyManagedConfigmap` should be created                                                      | `true`                                                                  |  |
