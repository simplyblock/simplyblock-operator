...
type StorageNodeSetSpec struct {
	...
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="mgmtIfname is immutable once set"
	...
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="partitions is immutable once set"
	...
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="nodesPerSocket is immutable once set"
	...
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="forceFormat4K is immutable once set"
