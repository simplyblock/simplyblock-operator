...
func (in *StorageNodeStatus) DeepCopyInto(out *StorageNodeStatus) {
	*out = *in
	...
	if in.NodePodEvents != nil {
		in, out := &in.NodePodEvents, &out.NodePodEvents
		*out = make(map[string]NodePodEvent, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodePodEvent) DeepCopyInto(out *NodePodEvent) {
	*out = *in
	in.ObservedAt.DeepCopyInto(&out.ObservedAt)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodePodEvent.
func (in *NodePodEvent) DeepCopy() *NodePodEvent {
	if in == nil {
		return nil
	}
	out := new(NodePodEvent)
	in.DeepCopyInto(out)
	return out
}
