...
// TestStorageClusterReconcileCreationSendsChecksumValidation covers the
// top-level checksum validation fields threading into the POST /api/v2/clusters/ payload.
