...
func schema_simplyblock_operator_api_metrics_v1alpha2_LogicalVolumeCapacity(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "LogicalVolumeCapacity is the space a volume occupies on the cluster it is provisioned from. Every size is in bytes and is quoted as a resource.Quantity so that kubectl prints it the way it prints a PersistentVolumeClaim's capacity.\n\nProvisioned against Used is the distinction the type exists for: a volume is thin-provisioned, so the size a claim asked for and the space the cluster has actually given it are different numbers, and only the first of them is visible anywhere in the Kubernetes API today.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"provisioned": {
						SchemaProps: spec.SchemaProps{
							Description: "Provisioned is the volume's nominal size: what the PersistentVolumeClaim asked for, and the number the volume reports to the initiator.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"used": {
						SchemaProps: spec.SchemaProps{
							Description: "Used is the space the volume actually occupies after thin provisioning, compression, and deduplication. It is the field a PersistentVolume cannot express.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"free": {
						SchemaProps: spec.SchemaProps{
							Description: "Free is the volume's unallocated remainder, as the control plane accounts for it. It is reported rather than derived, so it need not equal Provisioned minus Used.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"total": {
						SchemaProps: spec.SchemaProps{
							Description: "Total is the capacity the volume is charged against, which for a clone or a snapshot chain is larger than the volume alone.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"utilizationPercent": {
						SchemaProps: spec.SchemaProps{
							Description: "UtilizationPercent is the control plane's own utilization figure, from 0 to 100. It is taken verbatim rather than recomputed from Used and Provisioned, because the control plane accounts for shared blocks in a clone chain and a naive ratio does not.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
				...
				Required: []string{"provisioned", "used", "free", "total", "utilizationPercent"},
			},
		},
		Dependencies: []string{
...
func schema_simplyblock_operator_api_metrics_v1alpha2_LogicalVolumeMetrics(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "LogicalVolumeMetrics is one logical volume's capacity reading.\n\nThe object is named after the PersistentVolumeClaim it backs and lives in that claim's namespace, so a user who knows their claim's name needs to learn nothing else to ask for it, and ordinary namespaced RBAC confines a tenant to their own volumes. A logical volume with no bound claim is therefore not listed: it has no name in this API and no namespace to be authorized against.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "metadata is standard object metadata. Name and namespace are the backing PersistentVolumeClaim's; creationTimestamp is the claim's, not the reading's.",
					...
					"timestamp": {
						SchemaProps: spec.SchemaProps{
							Description: "Timestamp is when the control plane sampled these values, which is older than the moment the request was served and may be considerably older if the update stream has been disconnected.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"volumeHandle": {
						SchemaProps: spec.SchemaProps{
							Description: "VolumeHandle is the CSI volume handle, \"clusterID:poolID:volumeID.\" It is the join key back to the PersistentVolume and to the control plane.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"persistentVolume": {
						SchemaProps: spec.SchemaProps{
							Description: "PersistentVolume is the name of the cluster-scoped PersistentVolume bound to this object's claim.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"poolName": {
						SchemaProps: spec.SchemaProps{
							Description: "PoolName is the backend storage pool the volume was provisioned from.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"capacity": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/simplyblock/simplyblock-operator/api/metrics/v1alpha2.LogicalVolumeCapacity"),
						},
					},
				},
				Required: []string{"timestamp", "volumeHandle", "persistentVolume", "poolName", "capacity"},
			},
		},
		Dependencies: []string{
			"github.com/simplyblock/simplyblock-operator/api/metrics/v1alpha2.LogicalVolumeCapacity", v1.ObjectMeta{}.OpenAPIModelName(), v1.Time{}.OpenAPIModelName()},
	}
}

func schema_simplyblock_operator_api_metrics_v1alpha2_LogicalVolumeMetricsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "LogicalVolumeMetricsList is a list of readings. It carries no continue token: the whole set is served from memory in one pass, so there is nothing to page through.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/simplyblock/simplyblock-operator/api/metrics/v1alpha2.LogicalVolumeMetrics"),
									},
								},
							},
						},
...
func schema_simplyblock_operator_api_metrics_v1alpha2_StorageDeviceCapacity(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StorageDeviceCapacity is what one device holds. Every size is in bytes and is quoted as a resource.Quantity so that kubectl prints it the way it prints a PersistentVolumeClaim's capacity.\n\nUsed against Total is the pair the type exists for: cluster capacity is the sum of its devices, and a cluster at seventy per cent with one device at ninety-eight is a cluster about to have a problem that its own thresholds cannot see.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"total": {
						SchemaProps: spec.SchemaProps{
							Description: "Total is the space the device can hold, as the exporter measured it. It is the same number the device object's status.capacity carries, reported again here so that a reading is complete without a second lookup.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"used": {
						SchemaProps: spec.SchemaProps{
							Description: "Used is the space the device currently holds.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"free": {
						SchemaProps: spec.SchemaProps{
							Description: "Free is the device's unallocated remainder as the control plane accounts for it. It is reported rather than derived, so it need not equal Total minus Used.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"provisioned": {
						SchemaProps: spec.SchemaProps{
							Description: "Provisioned is the space promised out of the device, which on a thin-provisioned pool may exceed Total.",
							Ref:         ref(resource.Quantity{}.OpenAPIModelName()),
						},
					},
					"utilizationPercent": {
...
func schema_simplyblock_operator_api_metrics_v1alpha2_StorageDeviceMetrics(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StorageDeviceMetrics is one storage device's capacity reading.\n\nThe object is named after the StorageDevice it measures and lives in that object's namespace, so somebody who has the device's name needs to learn nothing else to ask for it, and ordinary namespaced RBAC confines a reader to the namespaces they already have. A device with no StorageDevice object is therefore not listed: it has no name in this API and no namespace to be authorized against.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "metadata is standard object metadata. Name and namespace are the StorageDevice's. The creationTimestamp is the device object's rather than the reading's.",
							Default:     map[string]interface{}{},
							Ref:         ref(v1.ObjectMeta{}.OpenAPIModelName()),
						},
					},
					"timestamp": {
						SchemaProps: spec.SchemaProps{
							Description: "Timestamp is when the control plane sampled these values, which is older than the moment the request was served and may be considerably older if its exporter has stopped being scraped. It is the zero time when the device has never been sampled, so that \"never measured\" does not read as \"measured in 1970.\"",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"deviceID": {
						SchemaProps: spec.SchemaProps{
							Description: "DeviceID is the control plane's identifier for the device. It is the join key back to the control plane's own exporter and to its API.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"storageNode": {
						SchemaProps: spec.SchemaProps{
							Description: "StorageNode is the name of the StorageNode object the device belongs to, so a reading says which machine it is about without a second lookup.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"capacity": {
						SchemaProps: spec.SchemaProps{
							Description: "Capacity is the reading itself.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/simplyblock/simplyblock-operator/api/metrics/v1alpha2.StorageDeviceCapacity"),
						},
					},
				},
				Required: []string{"timestamp", "deviceID", "storageNode", "capacity"},
			},
		},
		Dependencies: []string{
			"github.com/simplyblock/simplyblock-operator/api/metrics/v1alpha2.StorageDeviceCapacity", v1.ObjectMeta{}.OpenAPIModelName(), v1.Time{}.OpenAPIModelName()},
	}
}

func schema_simplyblock_operator_api_metrics_v1alpha2_StorageDeviceMetricsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StorageDeviceMetricsList is a list of readings. It carries no continue token: the whole set is served from memory in one pass, so there is nothing to page through.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/simplyblock/simplyblock-operator/api/metrics/v1alpha2.StorageDeviceMetrics"),
									},
								},
							},
						},
