...
| Stack record present but unparseable              | The file does not decode                         | The unstage fails and reports it rather than falling back to the legacy plan. That fallback answers an absent record, and a corrupt file is not evidence that a legacy stack was built (§6.1)   |
