...
`### vdoCapableSegment (design §4)` (`csi-driver/internal/spdk/controllerserver_test.go`)
...
`csi-driver/internal/util/vdo.go` itself has no direct unit tests (design §9): its
...
| Gap                                                                     | Reason                                                                                                                                              |
|-------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| `csi-driver/internal/util/vdo.go`'s own delegation lines                | No direct unit test file exists for this wiring. Every branch is a one-line call into already-tested `atlas-lib/lvm/vdo` functions (design §5, §9). |
