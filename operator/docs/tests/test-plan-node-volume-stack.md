...
| U-98  | A clone whose untagged source the recognizer knows is adopted on its device and then imported; one it does not know is refused with nothing issued against it                                                                                          | Negative   | `TestResolveClonedVolumeGroupRecognizesOrRefusesAnUntaggedSource`                              |
...
|----------------|-----------|---------|---------------------------------------|
| Unit           | 105       | 22      | U-01 … U-70, U-73 … U-76, U-78 … U-85, U-104 |
...
`atlas-lib/volstack/layers/lvmvolume_test.go`, and thirteen (U-92 … U-103,
U-105) cover the ownership tags of design §5.7 across `atlas-lib/lvm`, the
