...
| Multiple VDO instances present, then the node reboots together | **Not yet tested** — flagged explicitly as a gap in the design doc's Notes ("Multiple instances across a restart") | Negative | Integration |
