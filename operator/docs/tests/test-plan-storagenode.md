...
| #    | Scenario                                                                        | Type     | Test                                |
|------|---------------------------------------------------------------------------------|----------|-------------------------------------|
| U-77 | Workers gain the node-set label and carry no retired node-type label            | Positive | `TestStorageNodeSetLabelingHelpers` |
...
| U-78 … U-84                | The per-slot storage-node-uuid labels                                                         | The most consequential labels in the operator, and the only covered part is the per-set label. A wrong key here breaks CSI provisioning                                                                                                                                          |
