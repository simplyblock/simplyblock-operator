...
| U-16 | Resync: the failback endpoint is called, forwarding the `sourceClusterID` class parameter when given                                                                                                                                 | Positive          | `TestResyncVolume`, `TestResyncVolumeForwardsTheSourceClusterParameter`                                                                                            |
...
|------------------|------------------------------------------------------------------------|-----------------------------------------------------------------------------|-----------------------------------------------------------|
| Verb lifecycle   | enable, disable, info, forced promote, planned promote, demote, resync | U-01, U-02, U-04 … U-10, U-12 … U-17, U-40 … U-47, I-02 … I-04, E-01 … E-04 | —                                                         |
