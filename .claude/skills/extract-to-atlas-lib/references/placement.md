...
| `kube`           | lvol-to-PV, PVC, and VolumeAttachment correlation; driver, parameter, label, annotation, and finalizer keys; StorageClass properties; DNS-safe ids | correlating a volume with a Kubernetes object, or a key both sides read |
...
| `kube`           | 16       | 2          |                                                                         |
| `nvme`           | 4        | 4          |                                                                         |
| `nvmeof`         | 4        | 2          | two connect implementations still exist; the CSI driver uses `nvme-cli` |
| `errs`           | 1        | 3          |                                                                         |
| `errs/deferrers` | 0        | 3          |                                                                         |
| `net`            | 1        | 0          |                                                                         |
| `locks`          | 0        | 1          |                                                                         |
