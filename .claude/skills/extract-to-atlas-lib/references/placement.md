...
| `lvm`            | 0        | 0          | adopted by `csi-driver/internal/mount/vdo.go` on PR #402, not yet merged to `main` |
| `errs`           | 1        | 3          |                                                                                    |
| `errs/deferrers` | 0        | 3          |                                                                                    |
| `net`            | 1        | 0          |                                                                                    |
| `locks`          | 0        | 1          |                                                                                    |
...
| `csi-driver/internal/controlplane/cluster.go` | 341 lines   | The CSI half of the same duplication                                                                                                  |
