...
| `csi-driver/internal/**` and `csi-driver/e2e/**` files carrying an Apache header (23) | inherited upstream SPDK-CSI code. Reshaping it discards the provenance the header names |
