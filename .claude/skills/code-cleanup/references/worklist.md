...
| 4   | Two `atlas-lib` helpers copied into `csi-driver/internal/fabric/repair.go:356,373` because the originals are unexported                                                             | exact body match against `nvmeof/inspect.go:498` and `nvmeof/repair.go:600` | 3    | Low: export and adopt. See `extract-to-atlas-lib`           |
